...
namespace Collector
{
    ...
    {
        public void GetNews_3(int stepNumber)
        {
            int sourceId = 0;
            int countryId = 0;
            ...
            string url = "http://plaza.mediaroom.com/index.php?searchform=1&start=" + start_dt + "&end=" + cur_dt + "&s=2429";
            ...
            for (int pg = 1; pg < 100; pg++)
            {
                ...
                HtmlAgilityPack.HtmlNodeCollection itemColl = doc.DocumentNode.SelectNodes("//div[@class='item']");
                ...
                foreach (HtmlAgilityPack.HtmlNode item in itemColl)
                {
                    ...
                    obj.companyname = "Plaza Retail REIT";
